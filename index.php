...
<body>
	<nav class="navbar navbar-dark bg-danger fixed-top">
	  <a class="navbar-brand" href="index.php" style="color: black;">
	    David Nurkholik {18610099}
	  </a>
	</nav>

	<div class="container mb-3">
		<h2 align="center" style="margin: 60px 10px 10px 10px;">FORM KOMENTAR</h2><hr>
		<form method="POST" id="form_komen">
			...
			<div class="form-group">
				<textarea name="komen" id="komen" class="form-control" placeholder="Tulis Komentar" rows="10"></textarea>
			</div>
			<div class="form-group">
